...
//        intTable();
    ...
    private void initComponents() {
        ...
        setTitle("Contoh enggunaan Table");
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        InputStream file = penggunaanTabel.class.getResourceAsStream(filename);
        ...
        try {
            while ((Line = bufferedReader.readLine()) != null) {
                ...
                data.setNama(temp[1]);
                data.setGender(temp[2]);
                
                listData.add(data);
                modelData.setListData(listData);
                jTable1.setModel(modelData);
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(penggunaanTabel.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new penggunaanTabel().setVisible(true);
            }
        });
    }
